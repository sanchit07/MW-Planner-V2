...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Request DTO for creating or updating a custom fee")
public class CustomFeeRequestDTO {
  ...
  @Schema(
      description =
          "Campaign ID. If null, custom fee is for the company (user's active company). "
              + "If provided, custom fee is for this campaign.",
